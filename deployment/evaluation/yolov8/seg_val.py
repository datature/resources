...
@Desc    :   Evaluate performance of YOLOv8 segmentation
...
parser = argparse.ArgumentParser(
    description="Evaluate performance of YOLOv8 segmentation"
    "models on a validation set."
)
parser.add_argument(
    "-i",
...
def main():
    ...
    for pred in preds:
        ...
        for p in pred:
            ...
            mask = p.masks.xy[0].flatten().tolist()
            dct = {
    ...
    coco_eval = COCOeval(coco_annotation, coco_eval_prediction, "segm")
