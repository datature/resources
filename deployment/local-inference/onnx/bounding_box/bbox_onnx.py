...
@Desc    :   Simple predictor script for bounding box ONNX models.
'''
...
parser = argparse.ArgumentParser(
    prog="Datature Bounding Box ONNX Predictor",
    description="Predictor to Predict Bounding Box ONNX Model.")
