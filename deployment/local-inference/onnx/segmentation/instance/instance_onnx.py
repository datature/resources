...
@Desc    :   Simple predictor script for instance segmentation ONNX models.
'''
...
class Predictor:
    ...
    def postprocess(self, model_output: List[np.ndarray]) -> List:
        ...
        _, sco, classes, boxes, masks = model_output
        sco = sco[0]
...
parser = argparse.ArgumentParser(
    prog="Datature Instance Segmentation ONNX Predictor",
    description="Predictor to Predict Instance Segmentation ONNX Model.")
...
if __name__ == "__main__":
    ...
    predictor = Predictor(loaded_model, threshold)
