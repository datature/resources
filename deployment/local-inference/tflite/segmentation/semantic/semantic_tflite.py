...
@Desc    :   Simple predictor script for semantic segmentation TFLite models.
'''
...
class Predictor:
    ...
    def predict(self, image: np.ndarray) -> np.ndarray:
        ...
        predicted = self.model(inputs=preprocessed)["output"][0]
...
if __name__ == "__main__":
    ...
    output_name = interpreter.get_signature_list(
    )["serving_default"]["outputs"][0]
