# Datature Tensorflow Instance Segmentation Model Guide

This guide is for carrying out predictions using exported Datature Tensorflow Instance Segmentation models.
