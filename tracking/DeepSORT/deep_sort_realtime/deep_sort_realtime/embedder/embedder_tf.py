...
class MobileNetv2_Embedder(object):
    ...
    def preprocess(self, np_image):
        ...
        # print(np_image_rgb, type(np_image_rgb))
        np_image_rgb = cv2.resize(np_image_rgb, (224, 224))
    ...
    def predict(self, np_images):
        ...
        for this_batch in preproc_imgs:
            # this_batch = tf.stack(this_batch, axis=0)
            this_batch = this_batch[tf.newaxis, ...]
            output = self.model(this_batch)["detection_scores"]
