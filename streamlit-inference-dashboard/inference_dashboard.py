...
def load_model():
    ...
    if st.session_state.hash != st.session_state.project_secret + st.session_state.model_key:
        ...
        st.session_state.hash = st.session_state.project_secret + st.session_state.model_key
...
if __name__ == "__main__":
    ...
    if len(st.session_state.model_key) > 0 and len(
            st.session_state.project_secret) > 0:
        load_model()
        upload_images()
        predict_all()
        visualise()
