...
class Track:
    ...
    def to_tlwh(self, orig=False, oori=False):
        ...
        """
        return self.to_ltwh(orig=orig, oori=oori)

    def to_ltwh(self, orig=False, oori=False):
        """Get current position in bounding box format `(top left x, top left y,
        width, height)`.
        ...
        """
        if oori and self.original_ltwh is None:
            return None
    ...
    def to_tlbr(self, orig=False, oori=False):
        ...
        ndarray
            ...
            If `orig` is True and track is matched to a detection this round, then the original det is returned.
        """
        return self.to_ltrb(orig=orig, oori=oori)

    def to_ltrb(self, orig=False, oori=False):
        """Get current position in bounding box format `(min x, miny, max x,
        max y)`.
        ...
        ndarray
            ...
            If `orig` is True and track is matched to a detection this round, then the original det is returned.
        """
        ret = self.to_ltwh(orig=orig, oori=oori)
        if ret is None:
            return None
        ret[2:] = ret[:2] + ret[2:]
        return ret
